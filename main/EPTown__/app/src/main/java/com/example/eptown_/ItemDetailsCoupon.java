...
public class ItemDetailsCoupon extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 뒤로가기 눌렀을때 디테일 아이템 디테일로 화면 이동
        ImageView image = (ImageView) findViewById(R.id.getCouponBackIcon);
        image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ItemDetailsCoupon.this, ItemDetails.class);
