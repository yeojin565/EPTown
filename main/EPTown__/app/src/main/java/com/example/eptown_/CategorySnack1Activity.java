...
public class CategorySnack1Activity extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ImageView image = (ImageView) findViewById(R.id.btnCategorySnack1Back);
        ...
        textSnack1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CategorySnack1Activity.this, CategorySnack2Activity.class);
                startActivity(intent);
            }
        });
        ...
        textSnack2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CategorySnack1Activity.this, CategorySnack3Activity.class);
                startActivity(intent);
            }
        });
        ...
        textSnack3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CategorySnack1Activity.this, CategorySnack4Activity.class);
                startActivity(intent);
            }
        });
        ...
        textSnack4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CategorySnack1Activity.this, CategorySnack5Activity.class);
                startActivity(intent);
            }
        });
        ...
        textSnack5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CategorySnack1Activity.this, CategorySnack6Activity.class);
                startActivity(intent);
            }
        });
        ...
        textSnack6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CategorySnack1Activity.this, CategorySnack7Activity.class);
                startActivity(intent);
            }
        });
        ...
        ImageView image1 = (ImageView) findViewById(R.id.nowTapHomeIconCategorySnack1);
        ...
        ImageView image2 = (ImageView) findViewById(R.id.tapCommunityIconCategorySnack1);
        image2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CategorySnack1Activity.this, CommunityActivity.class);
                startActivity(intent);
            }
        });

        // 탭바에서 카테고리 아이콘 눌렀을때 카테고리 메인으로 화면 이동
        ImageView image3 = (ImageView) findViewById(R.id.tapCategoryIconCategorySnack1);
        image3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CategorySnack1Activity.this, CategoryMainActivity.class);
                startActivity(intent);
            }
        });

        // 탭바에서 병원 아이콘 눌렀을때 병원으로 화면 이동
        ImageView image4 = (ImageView) findViewById(R.id.tapHostpitalIconCategorySnack1);
        image4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CategorySnack1Activity.this, HospitalDetailsActivity.class);
                startActivity(intent);
            }
        });

        // 탭바에서 내 정보 아이콘 눌렀을때 내 정보로 화면 이동
        ImageView image5 = (ImageView) findViewById(R.id.tapMypageIconCategorySnack1);
        image5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CategorySnack1Activity.this, MyPageActivity.class);
                startActivity(intent);
            }
        });
        ...
        image6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CategorySnack1Activity.this,NoticeActivity.class);
                startActivity(intent);
            }
        });
        ...
        image7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CategorySnack1Activity.this,CartActivity.class);
                startActivity(intent);
            }
        });
